...
## Database Scheme
![Schema](/portfolio management system/schema.png)
...
- **Examples:**
![Initialize](/portfolio management system/initial.png)
...
![Functions](/portfolio management system/functions.png)
...
- **Parameters:**
  ...
  - `loss_percentage`: The maximum percentage loss before an alert is triggered.
- **Example:**
![Update](/portfolio management system/update.png)
...
- **Parameters:**
  ...
  - `quantity`: The number of shares of new ticker(s).
- **Example:**
![Add](/portfolio management system/add.png)
...
- **Example:**
![Delete](/portfolio management system/delete.png)
...
- **Example:**
![view](/portfolio management system/view.png)
...
- **Example:**
![Track](/portfolio management system/track.png)

### Example outcome of database
![Ticker](/portfolio management system/ticker.png)
![Transaction](/portfolio management system/transaction.png)